...
<div class="py-3 mb-4 shadow-sm bg-secondary border-top">
    <div class="container">
        <h6 class="mb-0">
            ...
            <a class="link-dark" href="{{ url( 'checkout') }}"> Checkout</a> 
        </h6>
    </div>
</div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row checkout-form">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="email" value="{{ Auth::user()->email }}" class="form-control" placeholder="E-mail Address">
                                </div>
                                ...
                                <div class="col-md-6 mt-3">
                                    <label>Country</label>
                                    <input type="text" name="country" value="{{ Auth::user()->country }}" class="form-control" placeholder="Country">
                                </div>
                                <div class="col-md-6 mt-3">
                                    <label>Postal Code</label>
                                    <input type="text" name="postalcode" value="{{ Auth::user()->postalcode }}" class="form-control" placeholder="PostalCode">
                                </div>
                            </div>
                        </div>
                    </div>
